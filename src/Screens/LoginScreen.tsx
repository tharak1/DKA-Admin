...
// import { EmployeeModel, cred } from '../Models/EmployeeModel';
...
//                 const user = doc.data() as EmployeeModel;
//                 setUser(user);
//             });
...
const LoginScreen: React.FC = () => {
    ...
    const handleSignIn = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setLoading(false); // Move setLoading(false) to the end of try-catch block
        }
    };
    return (
        <section className="bg-gray-50 dark:bg-gray-900">

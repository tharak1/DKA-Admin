...
const Navbar: React.FC<Navbarprops> = ({ name }) => {
    ...
    return (
        <div className="flex flex-row justify-between items-center space-x-2 sm:rounded-lg bg-white dark:bg-slate-700 px-4 py-1 max-sm:h-20 max-sm:fixed max-sm:w-full">
            <div className='flex'>

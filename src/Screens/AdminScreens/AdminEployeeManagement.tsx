...
//         </div>
//                 <div className='row-start-2 row-span-1 col-span-4 w-full'>
...
//         <div className='row-start-2 row-span-1 col-span-2 w-full h-full flex pb-3'>
//           <button
//             type="button"
...
//         <div className='col-span-6 row-span-8 grid grid-cols-4 grid-rows-auto gap-3 overflow-auto'>
//             {
...
const AdminEmployeeManagement:React.FC = () => {
  ...
  return (
    ...
    <>
      <div className='grid grid-cols-6 grid-rows-10 h-screen overflow-auto w-full p-6 gap-3'>
        <div className="col-span-6 mb-5 row-span-1">
          <Navbar name='Employee Management'/>
        </div>
        <div className='row-start-2 row-span-1 col-span-4 w-full'>

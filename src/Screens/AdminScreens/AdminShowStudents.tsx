...
//     try {
//       const studata = await getDoc(doc(db, 'students', searchKey));
//       if (studata.exists()) {
//         setStudent(studata.data() as UserModel);
//       } else {
//         setStudent(null);
//         setPerformances([]);
...
//                   </svg>
//               </div>
//               <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Student ID" required onChange={(e)=>{setSearchKey(e.target.value)}} />
...
//           <p className='text-blue-600 hover:text-blue-400 cursor-pointer' onClick={goToDetail}>Tap to show more</p>
//         </div>
...
//                 <div className='flex justify-between py-3 px-4 w-full bg-slate-100 dark:bg-slate-500 rounded-md my-1.5'>
...
//           <p className='text-blue-600 hover:text-blue-400 cursor-pointer'>Tap to show full payment history</p>
//         </div>
...
//               <div>
//                 <div>
//                   <p><span className='text-gray-700 text-xs'>Paid for :</span> <span className=''>{obj.courseName}</span> </p>
//                   <p><span className='text-gray-700 text-xs'>Paid on :</span> <span className=''>{obj.boughtDate}</span> </p>
//                 </div>
//                 <div>
//                   <p><span className='text-gray-700 text-xs'>Payment Id :</span> <span className=''>{obj.paymentId}</span> </p>
//                   <p><span className='text-gray-700 text-xs'>Status :</span> <span className=''>{obj.status}</span> </p>
//                 </div>
//               </div>
//               <div className='flex flex-col items-end justify-between'>
//                 <p><span className='text-gray-700 text-xs'>Ends on  :</span> <span className=''>{obj.boughtDate}</span> </p>
//                 <button type="button" className="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Extend By 2 days</button>
//               </div>
//             </div>
//             ))
//           }
      ...
      {loading ? (
        ...
        <>
          ...
          <div className='relative col-span-2 row-span-4 bg-white dark:bg-slate-700 rounded-lg p-3 dark:text-white'>
            <div className='absolute top-[-30px] left-1 flex justify-between w-full px-3'>
              <h2 className='mb-4'>Courses Registered:</h2>
              <p className='text-blue-600 hover:text-blue-400 cursor-pointer'>

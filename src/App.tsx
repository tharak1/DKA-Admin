...
import CreateQuestionPaper from './Screens/AdminScreens/AdminSupportScreens.tsx/AdminCreateQuestionPaper';
...
import AdminEmployeeManagement from './Screens/AdminScreens/AdminEployeeManagement';
...
import AdminAddCourseScreen from './Screens/AdminScreens/AdminSupportScreens.tsx/AdminAddCourseScreen';
...
function App() {
  ...
  return (
    <>
      ...
      <Router>
        <Suspense fallback={<div className='h-full w-full flex justify-center items-center'>
